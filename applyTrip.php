...
<html lang="en">
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="apply" style="margin-bottom: 50px;">
              <h4>Apply for a trip</h4><br>
              <p><u>TRIP DETAILS</u></p>
                <table>
                  <tr>
                    <th>Trip Date</th>
                    <th>Destination</th>
                  ...
                  <!-- to be displayed at the table form by calling the attributes -->
                  <?php while ($row = mysqli_fetch_array($result)){ ?>
                    <tr style="font-weight:400;">
                      <td><?php echo $row ['tripDate'] ?></td>
                      <td><?php echo $row ['destination'] ?> </td>
                      <td><?php echo $row ['description'] ?> </td>
                      <td><?php echo $row ['crisisType'] ?> </td>
                      <td><?php echo $row ['numberVol'] ?> </td>
                      <td><?php echo $row ['tripID'] ?> </td>
                      <form action="tripApplied.php" method="POST">
