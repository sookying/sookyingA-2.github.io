...
<html lang="en">
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="management">
                <img src="crsImages/profile.png" alt="profile" width="35" height="35" onclick="window.location.href='manageProfile.php';" id="profile">
                <img src="crsImages/view.jpg" alt="view status" width="30" height="30" onclick="window.location.href='viewStatus.php';" id="view">
              </div>
        
            <fieldset><legend> Manage Your Profile</legend>
                <form class="form-inline" method="POST" name="editForm" action="profileMngment.php">
                    <label>Name</label><input class="form-control" type="text" name="changeVname" placeholder="Enter your name"> 
                    <label>Password</label><input class="form-control" type="password" name="changeVpwd" id="pwd" placeholder="Enter a password">
                    <input type="checkbox" onclick="showPwd()"> Show Password
                    <br>
                    <label>Phone Number</label><input class="form-control" type="tel" name="changeVphone" placeholder="Enter your phone number">
                    <label>Document Type</label>
                    <select class="custom-select form-control" name="docType">
                        <option selected>Select a type</option>
                        <option value="Passport">Passport</option>
                        <option value="Visa">Visa</option>
                        <option value="Certificate">Certificate</option>
                    </select>
                    <label>Document Expiry Date</label><br><input class="form-control" type="date" name="docdate" placeholder="Enter expry date">
                    <label>Document Image</label><input class="form-control" type="file" name="file">
                    <br>
                    <button type="submit" class="btn btn-primary mb-2" name="submit">Save</button>
                    <button type="button" class="btn btn-primary mb-2" name="cancel" onclick="window.location.href='applyTrip.php';">Cancel</button>
                </form>
            </fieldset>
