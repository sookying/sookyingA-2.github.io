...
<html lang="en">
    ...
    <body>
        <div id="wrapper">
            ...
            <fieldset><legend>Manager Sign In</legend>
                <form class="form-inline" name="managerLoginForm" action="mauthenticate.php" method="POST">
                    <label class="sr-only" for="inlineFormInputGroupUsername2">Username</label>
                    <div class="input-group mb-2 mr-sm-2">
                        <div class="input-group-prepend">
                            <div class="input-group-text">@</div>
                        </div>
                        <input type="text" class="form-control" id="inlineFormInputGroupUsername2" placeholder="Enter your username" name="Musername">
                    </div>
                    <label class="sr-only" for="inlineFormInputName2">Password</label>
                    <input type="password" class="form-control mb-2 mr-sm-2" id="inlineFormInputName2" placeholder="Enter your password" name="Mpwd">
                    <input type="checkbox" class="form-check-input" name="remember"> Remember me <br><br>
                    <input type="submit" class="btn btn-primary mb-2" name="submit" id="btnLogin" onclick="managerLogin()">
                </form>
            </fieldset>
