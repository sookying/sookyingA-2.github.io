...
<html lang="en">
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="welcomeText">
                <p> Welcome back !</p>
                <p> It's time to apply a trip to help people that having natural disaster.</p>
            </div>
        
            <fieldset><legend> Volunteer Sign In</legend>
                <form class="form-inline" action="vauthenticate.php" method="POST" name="volLoginForm">
                    <label class="sr-only" for="inlineFormInputGroupUsername2">Username</label>
                    <div class="input-group mb-2 mr-sm-2">
                        <div class="input-group-prepend">
                            <div class="input-group-text">@</div>
                        </div>
                        <input type="text" class="form-control" id="inlineFormInputGroupUsername2" placeholder="Enter your username" name="Vusername" required>
                    </div>
                    <label class="sr-only" for="inlineFormInputName2">Password</label>
                    <input type="password" class="form-control mb-2 mr-sm-2" id="inlineFormInputName2" placeholder="Enter your password" name="Vpwd" required>
                    <input type="checkbox" class="form-check-input" name="remember"> Remember me <br><br>
                    <input type="submit" class="btn btn-primary mb-2" name="submit" id="btnLogin" onclick="volLogin()"> 
                </form>
            </fieldset>
